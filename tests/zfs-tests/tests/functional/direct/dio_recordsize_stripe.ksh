...
#
# DESCRIPTION:
# 	Verify different recordsizes are supported for disk VDEVs using Direct IO.
#
# STRATEGY:
...
log_assert "Verify different recordsizes are supported for disk VDEVs using Direct IO."
...
log_pass "Verify different recordsizes are supported for disk VDEVs using Direct IO."
