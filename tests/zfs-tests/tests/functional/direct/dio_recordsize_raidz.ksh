...
#
# DESCRIPTION:
# 	Verify different recordsizes are supported for raidz using Direct IO.
#
# STRATEGY:
#	1. Create raidz pool.
...
log_assert "Verify different recordsizes are supported for raidz using Direct IO."
...
for recsize in "1024" "4096" "128k" "1m"; do
	create_pool $TESTPOOL1 raidz $VDEVS
...
log_pass "Verified different recordsizes are supported for raidz using Direct IO."
