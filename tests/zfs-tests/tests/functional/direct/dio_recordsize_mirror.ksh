...
#
# DESCRIPTION:
# 	Verify different recordsizes are supported for mirrors using Direct IO.
#
# STRATEGY:
#	1. Create multidisk mirror pool.
...
log_assert "Verify different recordsizes are supported for mirrors using Direct IO."
...
for recsize in "1024" "4096" "128k" "1m"; do
	create_pool $TESTPOOL1 mirror $VDEVS
...
log_pass "Verified different recordsizes are supported for mirrors using Direct IO."
