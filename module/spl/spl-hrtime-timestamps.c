...
EXPORT_SYMBOL(hrtime_timestamp_init);
...
EXPORT_SYMBOL(hrtime_timestamp_fini);
...
EXPORT_SYMBOL(hrtime_taskq_count_init);
...
EXPORT_SYMBOL(hrtime_taskq_count_fini);
...
EXPORT_SYMBOL(hrtime_taskq_count_add_count);
...
EXPORT_SYMBOL(hrtime_taskq_count_dump);
...
EXPORT_SYMBOL(hrtime_add_timestamp_pipeline_stages);
...
EXPORT_SYMBOL(hrtime_add_timestamp_call_sites);
